...
class GaragesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create garage" do
    assert_difference('Garage.count') do
      post garages_url, params: { garage: { daily_price_cents: @garage.daily_price_cents, location: @garage.location } }
    end
  ...
  test "should update garage" do
    patch garage_url(@garage), params: { garage: { daily_price_cents: @garage.daily_price_cents, location: @garage.location } }
